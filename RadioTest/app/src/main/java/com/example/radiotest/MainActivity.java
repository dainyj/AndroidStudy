...
public class MainActivity extends AppCompatActivity {
    ...
    public void onSelectButtonClicked(View v) {
        if (rb1.isChecked() == true) {
            Toast.makeText(getApplicationContext(), R.string.msg_button1, Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(getApplicationContext(), R.string.msg_button2, Toast.LENGTH_SHORT).show();
        }
    }
